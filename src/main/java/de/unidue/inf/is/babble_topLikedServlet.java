...
public final class babble_topLikedServlet extends HttpServlet  {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {	
   		String top5String ="SELECT b.text,b.created,b.creator,b.id, count(lb.babble) AS likes FROM babble b INNER JOIN likesbabble lb ON lb.babble=b.id GROUP BY  b.text,b.created,b.creator,b.id ORDER BY likes FETCH FIRST 5 ROWS ONLY  ";
